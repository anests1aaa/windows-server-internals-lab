...
6. [Fase 6 — ObOpenObjectByName](./06-obopenobjectbyname-reversing.html) — reversing completo: validación de entrada, `SeCreateAccessState`, `ObpCaptureObjectAttributes`, `SeCaptureSecurityDescriptor`, y entrega a `ObpLookupObjectName`, todo confirmado en vivo con `i386kd`
